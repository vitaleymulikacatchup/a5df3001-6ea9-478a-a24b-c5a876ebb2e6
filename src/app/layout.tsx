...
export const metadata: Metadata = {
  title: "Vitaliy 'Superkot' Zalupenko: CS2 Legend (Official Fan Site)",  description: "Discover the unmatched 'talent' of Vitaliy 'Superkot' Zalupenko, the CS2 player with 0 kills and 24 deaths per match. A tribute to his unique approach to gaming!",  keywords: ["Superkot", "Vitaliy Zalupenko", "CS2", "Counter-Strike", "worst player", "funny gamer", "esports meme", "flashbang fail", "0 kills", "24 deaths"],
  openGraph: {
    title: "Vitaliy 'Superkot' Zalupenko: CS2 Legend (Official Fan Site)",    description: "Discover the unmatched 'talent' of Vitaliy 'Superkot' Zalupenko, the CS2 player with 0 kills and 24 deaths per match. A tribute to his unique approach to gaming!",    url: "https://superkot.fun",    siteName: "Superkot Fan Club",    images: [
      {
        url: "https://img.b2bpic.net/free-photo/young-hispanic-man-streamer-stressed-using-computer-gaming-room_839833-35208.jpg",        alt: "Vitaliy 'Superkot' Zalupenko"},
    ],
    type: "website"},
  twitter: {
    card: "summary_large_image",    title: "Vitaliy 'Superkot' Zalupenko: CS2 Legend (Official Fan Site)",    description: "Discover the unmatched 'talent' of Vitaliy 'Superkot' Zalupenko, the CS2 player with 0 kills and 24 deaths per match. A tribute to his unique approach to gaming!",    images: ["https://img.b2bpic.net/free-photo/young-hispanic-man-streamer-stressed-using-computer-gaming-room_839833-35208.jpg"],
  },
  robots: {
    index: true,
    follow: true,
